 ...
 * a sleepaway summer camp on California's Monterey Peninsula.
 */
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-xs font-mono uppercase tracking-wider text-warning">
            Monterey, California · Summer Sleepaway Camp
          </div>
          ...
          <div className="text-sm text-muted-foreground mt-0.5">
            Overnight summer camp on the Monterey Peninsula — hiking, sailing,
            archery & campfires. Now enrolling for summer sessions.
          </div>
        </div>
